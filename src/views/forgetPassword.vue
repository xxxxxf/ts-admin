  ...
  <div class="change-pw content-table">
    <div class="change-sty">
      <div class="change-top">
        <span>智布互联电商后台管理系统</span>
      </div>
      <el-row class="auto-sty">
        ...
        <el-row class="main main-table">
          ...
          <div class="auto" v-show="isHidden === 1" :span="24">
            <div class="change-password-box">
              <div class="phone-bind">
                ...
                <div>
                  <el-input :value="mobile" v-model="mobile" />
                </div>
              </div>
              <div>
                <div class="item-title">
          ...
          <el-col v-if="isHidden === 2" :span="24">
            <div class="change-mobile-box">
              ...
              >
                ...
                <i class="is-sff-required fl" style="margin:6px 5px 0 0">*</i>
                <el-form-item style="width:96%;margin-bottom: 30px;" class="fl" label="确认密码" prop="checkPass">
                  <el-input
...
export default class Index extends Vue {
  ...
  private async getCode() {
    window.$imageStabilization( async () => {
      let result: any = await window.$request.post(
        `${domain}` + "/api/user/modify-self-phone",
        {
          body: {
            phone: this.mobile,
            number: 1
  ...
  private async submitStepOne() {
    window.$imageStabilization( async () => {
      let result: any = await window.$request.post(
        `${domain}` + "/api/user/check-self-phone",
        {
          body: {
            phone: this.mobile,
            number: 1,
  ...
  private async submit() {
    window.$imageStabilization( async () => {
      let result: any = await window.$request.post(
        `${domain}` + "/api/user/modify-self-pass",
        {
          body: {
