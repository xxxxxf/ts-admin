      ...
      <el-col class="auto" :span="24">
        <div class="step">
          <el-steps :active="active" finish-status="success" align-center>
            ...
            <el-step title="更改手机" class="step-title"></el-step>
        ...
        <div class="change-password-box">
          ...
          <div>
            ...
            <div class="main-table-item">
              <el-col :span="16">
                <el-input style="width:100%;" v-model="ver_code" @keyup.native.enter = "submitStepOne" />
              </el-col>
      ...
      <el-col v-if="isHidden === 2" :span="24">
        <div class="change-mobile-box">
          ...
          <div>
            ...
            <el-col :span="16">
              <el-input style="width:100%;" v-model="newCode" @keyup.native.enter = "submit" />
            </el-col>
            <el-col :span="8" align="center" :class="{'get-code-btn':!isShow}" class="send-code">
              <span v-if="isShow" @click.stop="sendCode">发送验证码</span>
              <span v-if="!isShow">{{ time }}s</span>
            </el-col>
          </div>
          <div class="submit">
...
export default class Index extends Vue {
  private validatePass = (rule: any, value: any, callback: any) => {
    ...
    } else if (!/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d_]{6,18}$/.test(value)) {
      callback(new Error("请输入6-18位,含数字及字母"));
    } else {
      callback();
    }
  };
